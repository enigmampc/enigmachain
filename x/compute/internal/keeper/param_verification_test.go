...
func multisigTxCreator2(t *testing.T, ctx *sdk.Context, keeper Keeper, n int, threshold int, actualSigners int, sdkMsg sdk.Msg) sdk.AccAddress {
...
func getSignBytes(ctx sdk.Context, acc client.Account, tx auth.StdTx) []byte {
